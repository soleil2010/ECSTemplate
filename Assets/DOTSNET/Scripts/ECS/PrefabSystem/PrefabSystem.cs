...
namespace DOTSNET
{
    ...
    public partial class PrefabSystem : SystemBase
    {
        ...
        readonly Dictionary<Guid, GameObject> gameObjectPrefabs = new Dictionary<Guid, GameObject>();
        ...
        //       player prefabs etc.
        public readonly Dictionary<FixedBytes16, Entity> prefabs = new Dictionary<FixedBytes16, Entity>();
        ...
        public readonly Dictionary<FixedBytes16, Entity> scenePrefabs = new Dictionary<FixedBytes16, Entity>();
        ...
        internal void ConvertGameObjectPrefabs()
        {
            ...
            foreach (KeyValuePair<Guid, GameObject> kvp in gameObjectPrefabs)
            {
                ...
                FixedBytes16 prefabId = Conversion.GuidToBytes16(kvp.Key);
        ...
        {
            Entities.ForEach((ref NetworkIdentity identity, in Entity entity) =>
            {
                ...
                // get prefabId
                FixedBytes16 prefabId = identity.prefabId;
        ...
        public bool Get(FixedBytes16 prefabId, out Entity prefab)
        {
