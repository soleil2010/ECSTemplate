...
namespace DOTSNET
{
    public class DistanceInterestManagementSystemAuthoring : MonoBehaviour, SelectiveSystemAuthoring
    {
        // find systems in ECS world
        NetworkServerSystem server =>
            Bootstrap.ServerWorld.GetExistingSystem<NetworkServerSystem>();
        DistanceInterestManagementSystem system =>
            Bootstrap.ServerWorld.GetExistingSystem<DistanceInterestManagementSystem>();
        ...
        public Type GetSystemType() => typeof(DistanceInterestManagementSystem);
        ...
        void Update()
        {
            system.visibilityRadius = visibilityRadius;
